<template>
    ...
    <el-option
      ...
      <el-table
        ...
        <el-table-column prop="fanwenkuId" label="范文库编码" width="200" />
        <el-table-column prop="fanwenkuName" label="范文库名称" width="150" />
        <el-table-column prop="articleId" label="文章编码" width="200" />
        <el-table-column prop="content" label="文章内容" width="200" :show-overflow-tooltip="true">
          <template slot-scope="scope">
             <a
        ...
        <el-table-column label="操作" width="300" align="center">
          <template slot-scope="scope">
            ...
            <el-button type="danger" size="mini" icon="el-icon-delete" @click="removeDataById(scope.row.articleId)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
  <!-- 分页 -->
    ...
    handleExceed(files, fileList) {
      this.$message.warning(`当前限制选择 3 个文件，本次选择了 ${files.length} 个文件，共选择了 ${files.length + fileList.length} 个文件`);
          ...
          openDialog(row){
            ...
            article.updateHistoryById(row.articleId)
          .then(reponse => {
           //预览操作
          })
          } ,
